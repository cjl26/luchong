...
public class ThreeDES {
    ...
    public static void main2(String[] args) {  
        ...
        byte[] enk = hexStringToBytes("222222222222222222222222222222222222222222222222");
       // Security.addProvider(new com.sun.crypto.provider.SunJCE());  
        //String password = "1234567";//密码  
        byte[] source = hexStringToBytes("2016102020120000");
        //System.out.println("加密前的字符串:" + password);  
        byte[] encoded = encryptMode(enk,source);  
        String pword = byte2Hex(encoded);
        System.out.println("加密后的字符串:" + pword);  
          
        //byte[] reqPassword = hex(pword);  
        byte[] cipher = hexStringToBytes("5BE5C3E3F5820D27E8CE26DFE6859DD4");
        byte[] srcBytes = decryptMode(enk,cipher);  
